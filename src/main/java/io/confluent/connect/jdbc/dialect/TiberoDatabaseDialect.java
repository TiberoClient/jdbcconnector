...
/**
 * A {@link DatabaseDialect} for Tibero.
 */
public class TiberoDatabaseDialect extends GenericDatabaseDialect {

  /**
   * The provider for {@link TiberoDatabaseDialect}.
   */
  public static class Provider extends SubprotocolBasedProvider {
    public Provider() {
      super(TiberoDatabaseDialect.class.getSimpleName(), "tibero");
    }

    @Override
    public DatabaseDialect create(AbstractConfig config) {
      return new TiberoDatabaseDialect(config);
    }
  }
   ...
   */
  public TiberoDatabaseDialect(AbstractConfig config) {
